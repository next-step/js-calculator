...
## 🖍피드백 사항
- [x] index.html에 =기호의 id 값을 equal-sign으로 변경
- [x] package.json내용 변경
- [x] EOL 수정
- [x] clickModifier() 를 호출하는 것과 다른 작용인것일까? (index.js 48라인) 
  - modifier는 결과값을 clear하는 개념이라고 생각했고 48라인에 else는 동작을 막는 용도로 생각했습니다..
- [x] 화살표 함수만 사용하는 이유가 있을까?
  - 부끄러운 답변이지만 딱히 고민하지않고 사용해왔습니다. 메서드나 함수를 사용할 때 생각을 하면서 사용해보겠습니다!
## 📊 테스트 요구사항
