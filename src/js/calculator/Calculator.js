...
export class Calculator {
    constructor(state){
        ...
        UI_COMPONENT.$digitsArea.addEventListener('click',this.clickDigit.bind(this));
        UI_COMPONENT.$operationsArea.addEventListener('click',this.clickOperator.bind(this));
        UI_COMPONENT.$modifiersArea.addEventListener('click',this.clickAC.bind(this));
    }
    setState(state){
        this.state = state;
    }
