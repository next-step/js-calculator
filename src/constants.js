...
const PLUS_TEST = '123+456';
const MINUS_TEST = '123-456';
const MULTIPLY_TEST = '123X456';
const DIVIDE_TEST = '500/5';
const AC_TEST = '555';
const THREE_LENGTH_NUMBER = '123';
const DIVIDE_TEST_FLOOR = '5/2';
...
export { BUTTON, RESTRICTIONS, OPERRATORS, ERROR_MESSEAGE, TEST };
